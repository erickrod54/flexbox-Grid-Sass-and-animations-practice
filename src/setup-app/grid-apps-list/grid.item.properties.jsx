 ...
 * 
 *      --> Destructuring 'gridPlaceselfHandler' from the 
 *          context.
 * 
...
const GridItemProperties = () => {
    ...
    const { itemSelection, gridPlaceSelfData, gridJustifySelfData, gridAlignSelfData, gridPlaceselfHandler, gridplaceself } = useGridContext()
