 ...
 * AppElementResponsiveWebDesign - Features:
 * 
 *      --> Building 'AppElementResponsiveWebDesign'
 *           
 * Note: This Component will serve as a link to each 
 * 'Web Design Fundamentals' sub app  
 */

const AppElementResponsiveWebDesign = ({id, name, desc, category, url}) => {
...
export default AppElementResponsiveWebDesign;
